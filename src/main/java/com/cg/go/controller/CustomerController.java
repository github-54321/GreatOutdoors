...
public class CustomerController {
	...
	public ResponseEntity<List<Customer>> updateCustomer(@Valid @RequestBody Customer customer) {
	...
	//Login User
	@GetMapping("logincustomer/{customerEmail}/{customerPassword}")
	public ResponseEntity<Customer> loginUser(@PathVariable("customerEmail") String customerEmail, @PathVariable("customerPassword") String customerPassword) {
		LOGGER.info("Userdata loginUser() started");
//		Customer customer = new Customer();
//		customer.setEmail(customerEmail);
//		customer.setCustomerPassword(customerPassword);
	    Customer login =  customerService.loginCustomer(customerEmail,customerPassword);
