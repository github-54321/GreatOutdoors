...
public class CartController {
	...
	@DeleteMapping(path="/deletecartitem/{userId}/{productId}")
	public ResponseEntity<List<CartItemEntity>> deleteCartItem( @PathVariable  int userId,@PathVariable String productId) throws CartException {
		LOGGER.info("CartEntity deleteCartItem() started");
		List<CartItemEntity> list=cartService.deleteCartItem(userId,productId);
