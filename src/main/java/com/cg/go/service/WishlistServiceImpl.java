...
public class WishlistServiceImpl implements IWishlistService{
    ...
    @Override
    @Transactional
    public List<Wishlist> addWishlistItem(int customerId,String productId)  throws WishlistException{
        	...
        	//Finding product by productId
             ...
             if(!(product==null)) {    
            	//Finding WishList for user
            	 Wishlist wish1= wishRepository.findByCustomer(customer);
            	 if(wish1!=null) {
    ...
    @Override
    @Transactional
    public void deleteWishlist(int customerId) throws WishlistException {
    	LOGGER.info("Wishlist deleteWishlist() started");
        Customer customer=customerRepository.findById(customerId).orElse(null);
         Wishlist wish= wishRepository.findByCustomer(customer);
    ...
    @Override
    @Transactional
    public void deleteWishlistItem(String productId, int customerId) throws WishlistException {
    ...
    @Override
    @Transactional
    public Wishlist findWishlistItem(String productId, int customerId) throws WishlistException {
    ...
    @Override
    @Transactional
    public Wishlist findWishlist(int customerId) throws WishlistException {
